...
function calculateTip(tipPercent, billTotal){
    return "Here is the total tip amount you want to give: $" + (tipPercent * billTotal);
}
...
let tipPercent = prompt("What is the tip percentage that you want to give?");
...
function applyDiscount(price, discount){
    ...
    return "The total after the applied discount is $" + price;
}

let price = prompt("What is the total price?");
